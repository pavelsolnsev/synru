import MArticlesSlider from './MArticlesSlider.vue';
import { synergyApi } from '~/utils/mediaCdn';

export default {
  title: 'Molecules/MArticlesSlider',
  component: MArticlesSlider,
  argTypes: {
    titleClass: {
      control: { type: 'text' },
    },
...
const Template = (args) => ({
  components: { MArticlesSlider },
  setup() {
    return { args };
  },
  template: '<div style="margin-top: 80px;"><m-articles-slider v-bind="args" /></div>',
});
