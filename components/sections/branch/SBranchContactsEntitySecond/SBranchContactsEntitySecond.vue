...
function formatContactInfo(additionalPhone: string | null, additionalEmail: string | null) {
  return [
    {
    ...
    },
    {
      ...
      normalizePhone: additionalPhone ? normalizePhoneNumber(additionalPhone) : '',
      email: additionalEmail ? additionalEmail?.toLowerCase() : '',
    },
  ];
}
    ...
    <div class="s-contacts-second__items">
      ...
      >
        ...
        <div class="s-contacts-second__item__info">
          ...
          <div class="s-contacts-second__item__info-text a-font_xl-m">
...
@import './SBranchContactsEntitySecond.scss';
</style>
