...
import { defaultHistoryItems } from '../SSuccessHistory/success-history-data';
...
const publishedDate = entity?.published_at ? convertMskToUTC(entity.published_at) : '';
...
@import './SSuccessHistorySecond.scss';
</style>
