import SOpenDay from './SOpenDay.vue';
import { synergyApi } from '~/utils/mediaCdn';

export default {
  title: 'Sections/SOpenDay',
  component: SOpenDay,
  argTypes: {},
};
...
const Template = (args) => ({
  ...
  template: '<s-open-day v-bind="args"/>',
});
...
Default.args = {
  ...
  image: synergyApi('uploads/content/s-open-day/thumb_sm.webp'),
  imageMd: synergyApi('uploads/content/s-open-day/thumb_md.webp'),
  imageLg: synergyApi('uploads/content/s-open-day/thumb_lg.webp'),
