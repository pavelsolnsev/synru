...
import { slides } from './sMainQuizFirstData';

const { width: windowWith } = useWindowSize();

const isShowQuiz = ref(false);

const slidesToShow = shallowRef(slides.slice(0,1));
    ...
    1200: {
      pagination: {
        ...
        renderBullet: function (index: number, className: string) {
          const slideTitle = slidesToShow.value[index].title;
          const paginationImage = slidesToShow.value[index].paginationImage;
          return `
            <div class="custom-bullet ${className}">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 150 173">
              <path fill="none" stroke="transparent" stroke-width="1.5" d="M 75,0 L 134,0 C 134,0 150,0 150,16 L 150,164 C 150,164 150,173 134,173 L 16,173 C 16,173 0,173 0,164 L 0,16 C 0,16 0,0 16,0 Z"/>
              </svg>
            </div>
          `;
        },
