...
const {
  ...
  breakpoints: {
    1200: {
      slidesPerView: slides.length > 4 ? 4 : 'auto',
      spaceBetween: 20,
    },
  },
});
  ...
  >
    <div class="s-level-intro__inner">
      ...
      <div class="s-level-intro__content">
        ...
        <ul
          v-if="tags.length"
          class="s-level-intro__tags a-font_m-m"
        ...
        >
          <li
            ...
            :key="tag.tag"
          >
            <ASvgMono name="simple-star4" />
            <span v-html="tag.tag" />
          </li>
        </ul>
        <p
          class="a-font_h5 s-level-intro__text"
          v-html="text"
        />
        <MQuizForm
